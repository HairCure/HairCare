...
//                      value: "Stage \(stage)",
//                      color: stageColor(stage),
//                      infoURL: URL(string: "https://en.wikipedia.org/wiki/Hamilton%E2%80%93Norwood_scale"))
//
//            resultRow(label: "Hair Type",
//                      value: hairType,
//                      color: Color(red: 0.2, green: 0.55, blue: 0.9))
...
//    }
//
//    private func resultRow(label: String, value: String, color: Color, infoURL: URL? = nil) -> some View {
//        HStack {
//            Text(label)
//                .font(.system(size: 15))
//                .foregroundStyle(.primary)
