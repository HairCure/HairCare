...
//                    HStack { Spacer(); VegFilterPicker(selection: $vegFilter) }
//
...
//    let foods: [Food]; let mealColor: Color; let showHeading: Bool
//    let onAdd: (Food) -> Void; let onTap: (Food) -> Void
//
//    var body: some View {
//        VStack(alignment: .leading, spacing: 14) {
//            if showHeading { Text("Suggested Meals").font(.system(size: 20, weight: .bold)) }
//            if foods.isEmpty {
